...
public class MySQL extends SQLConnector {
    ...
    private void biteMyShinyMetalAss() {
        ...
        String query2 = "CREATE TABLE IF NOT EXISTS mooperms_gindex(id INT NOT NULL AUTO_INCREMENT, name VARCHAR(32) UNIQUE NOT NULL, creation TIMESTAMP DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(id), INDEX(name))Engine=InnoDB DEFAULT CHARSET=utf8mb4;";
